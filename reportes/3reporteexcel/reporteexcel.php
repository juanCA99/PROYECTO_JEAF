<?php
	...
	$consulta = "SELECT identificacion, nombre, apellido, ciudad, telefono, direccion, correo, contrasena FROM registrarse";
	...
	if($resultado->num_rows > 0 ){
		...
		$titulosColumnas = array('identificacion', 'nombre','apellido','ciudad','telefono','direccion','correo','contrasena');
